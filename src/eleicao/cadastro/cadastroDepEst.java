 ...
 * @matricula 184450029
 */
public class cadastroDepEst extends javax.swing.JFrame {

    /**
     * Creates new form cadastroDepEst
     */
    public cadastroDepEst() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Dep. Estadual");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DeputadoEstadual depEst = new DeputadoEstadual(nomeInput.getText(),
                partidoInput.getText(),
                Integer.parseInt(numeroInput.getText()));
        if(!ContainerCandidatos.confere(depEst)) {
            ContainerCandidatos.getCandidatos().add(depEst);
