...
public class cadastroGovernador extends javax.swing.JFrame {
    ...
    /**
     * Creates new form cadastroGovernador
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Governador");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Governador gov = new Governador(nomeInput.getText(),
                partidoInput.getText(),
                Integer.parseInt(numeroInput.getText()));
        if(!ContainerCandidatos.confere(gov)) {
            ContainerCandidatos.getCandidatos().add(gov);
