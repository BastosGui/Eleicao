...
public class cadastroSenador extends javax.swing.JFrame {
    ...
    /**
     * Creates new form cadastroSenador
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Senador");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Senador sen = new Senador(nomeInput.getText(),
                partidoInput.getText(),
                Integer.parseInt(numeroInput.getText()));
        if(!ContainerCandidatos.confere(sen)) {
            ContainerCandidatos.getCandidatos().add(sen);
