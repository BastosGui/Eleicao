...
public class cadastroPresidente extends javax.swing.JFrame {
    ...
    /**
     * Creates new form cadastroPresidente
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Presidente");
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Presidente presi = new Presidente(nomeInput.getText(),
                partidoInput.getText(),
                Integer.parseInt(numeroInput.getText()));
        if(!ContainerCandidatos.confere(presi)) {
            ContainerCandidatos.getCandidatos().add(presi);
